...
from i18n_helpers import localized_handle_main_menu
...
def main():
    ...
    conv_handler = ConversationHandler(
        entry_points=[MessageHandler(filters.TEXT & ~filters.COMMAND, lambda update, context: localized_handle_main_menu(update, context, handle_main_menu))],
        states={
